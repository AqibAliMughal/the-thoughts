    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link nav-text" aria-current="page" href="admin-dashboard.php">Dashboard</a>
        </li>
        <?php 
        if(isset($_SESSION['user']))
        {
          ...
          <li class="nav-item dropdown mt-2">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="categoryPages/category-blogs.php">Tech</a></li>
              <li><a class="dropdown-item" href="categoryPages/category-blogs.php">Freelancing</a></li>
              <li><a class="dropdown-item" href="categoryPages/category-blogs.php">Education</a></li>
            </ul>
          </li>
          </li>
          <li class="nav-item">
