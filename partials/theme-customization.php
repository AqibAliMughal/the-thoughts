...
<body>
  ...
  <main>
    <div class="flex-shrink-0 p-3 " style="width: 145px; height:0px">
      <div class="dropdown">
        <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" id="theme-customization" data-bs-toggle="dropdown" aria-expanded="false">
          <strong>Customize</strong>
        </a>

          <form style="width:350px;" action="admin-dashboard/setting.php" method="POST" class="dropdown-menu text-small shadow p-2" aria-labelledby="theme-customization">
      <center>
      <table cellspacing="5px" style="width: ">
        ...
        <center>
         ...
         /*       for ($i=0; $i <$length ; $i++) 
          ...
          <!--<tr>
                ...
                <td><input type="color" name="background-color" id="" value="#fefa23"></td>
              </tr>
              <tr>
                <th>
                  Color
